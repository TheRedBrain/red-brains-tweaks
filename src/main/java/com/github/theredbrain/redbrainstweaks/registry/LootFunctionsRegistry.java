...
import com.github.theredbrain.redbrainstweaks.loot.function.CopyMealFunctionSerializer;
import com.github.theredbrain.redbrainstweaks.loot.function.SmokerCookFunctionSerializer;
...
public enum LootFunctionsRegistry {
    ...
    public static void registerAll() {
        for (LootFunctionsRegistry value : values()) {
            Registry.register(Registry.LOOT_FUNCTION_TYPE, new Identifier(RedBrainsTweaks.MOD_ID, value.pathName), value.type());
        }
    }
