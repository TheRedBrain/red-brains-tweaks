package com.github.theredbrain.redbrainstweaks.block.entity.screen;
...
import com.github.theredbrain.redbrainstweaks.block.entity.inventory.CookingPotMealSlot;
import com.github.theredbrain.redbrainstweaks.block.entity.inventory.CookingPotResultSlot;
...
import com.github.theredbrain.redbrainstweaks.registry.ExtendedScreenTypesRegistry;
...
public class CookingPotScreenHandler extends ScreenHandler {
    ...
    public static final Identifier EMPTY_CONTAINER_SLOT_BOWL = new Identifier(RedBrainsTweaks.MOD_ID, "item/empty_container_slot_bowl");
    ...
    public boolean canUse(PlayerEntity playerIn) {
        return canUse(canInteractWithCallable, playerIn, BlocksRegistry.COOKING_POT);
    }
