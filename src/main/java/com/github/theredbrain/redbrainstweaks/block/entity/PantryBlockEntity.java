...
import com.github.theredbrain.redbrainstweaks.block.PantryBlock;
...
public class PantryBlockEntity extends LootableContainerBlockEntity {
    ...
    public PantryBlockEntity(BlockPos blockPos, BlockState blockState) {
        this(EntitiesRegistry.PANTRY_ENTITY, blockPos, blockState);
    }
    ...
    protected Text getContainerName() {
        return RedBrainsTweaks.i18n("container.pantry");
    }
