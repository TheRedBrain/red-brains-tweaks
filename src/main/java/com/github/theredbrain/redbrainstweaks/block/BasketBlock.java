...
import com.github.theredbrain.redbrainstweaks.block.entity.BasketBlockEntity;
...
public class BasketBlock extends InventoryBlockWithEntity implements Waterloggable {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, EntitiesRegistry.BASKET_ENTITY, BasketBlockEntity::tick);
    }
