...
public class TomatoBushCropBlock extends CropBlock implements Fertilizable {
    ...
    protected boolean canPlantOnTop(BlockState floor, BlockView world, BlockPos pos) {
        return floor.isOf(Blocks.FARMLAND) || floor.isOf(BlocksRegistry.RICH_SOIL_FARMLAND);
    }
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(BlocksRegistry.TOMATO_CROP);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!isMature && player.getStackInHand(hand).getItem() == Items.BONE_MEAL) {
            ...
            dropStack(world, pos, new ItemStack(ItemsRegistry.TOMATO, j));
