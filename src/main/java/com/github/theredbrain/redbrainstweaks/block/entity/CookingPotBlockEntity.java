...
import com.github.theredbrain.redbrainstweaks.block.CookingPotBlock;
import com.github.theredbrain.redbrainstweaks.block.entity.screen.CookingPotScreenHandler;
import com.github.theredbrain.redbrainstweaks.inventory.ItemStackHandler;
import com.github.theredbrain.redbrainstweaks.inventory.RecipeWrapper;
import com.github.theredbrain.redbrainstweaks.recipe.CookingPotRecipe;
import com.github.theredbrain.redbrainstweaks.registry.EntitiesRegistry;
import com.github.theredbrain.redbrainstweaks.registry.RecipeTypesRegistry;
...
public class CookingPotBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, Nameable {
    ...
    public CookingPotBlockEntity(BlockPos blockPos, BlockState blockState) {
        this(EntitiesRegistry.COOKING_POT_ENTITY, blockPos, blockState, RecipeTypesRegistry.COOKING_RECIPE_SERIALIZER.type());
    }
    ...
    @Override
    public Text getName() {
        return customName != null ? customName : RedBrainsTweaks.i18n("container.cooking_pot");
    }
