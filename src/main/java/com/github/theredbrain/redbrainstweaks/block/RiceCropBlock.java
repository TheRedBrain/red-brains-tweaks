...
public class RiceCropBlock extends PlantBlock implements Fertilizable, FluidFillable {
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        ...
        if (ageGrowth <= MAX_AGE) {
            ...
            if (top.getBlock() == BlocksRegistry.RICE_UPPER_CROP) {
                ...
                RiceUpperCropBlock riceUpper = (RiceUpperCropBlock) BlocksRegistry.RICE_UPPER_CROP;
    ...
    public boolean isSupportingRiceUpper(BlockState topState) {
        return topState.isOf(BlocksRegistry.RICE_UPPER_CROP);
    }
