...
import com.github.theredbrain.redbrainstweaks.block.plants.CustomCropBlock;
...
public class CustomFarmlandBlock extends FallingBlock {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        return !this.getDefaultState().canPlaceAt(ctx.getWorld(), ctx.getBlockPos()) ? BlocksRegistry.LOOSE_DIRT_BLOCK.getDefaultState() : super.getPlacementState(ctx);
    }
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        if (canFallThrough(world.getBlockState(pos.down())) && pos.getY() >= world.getBottomY()) {
            FallingBlockEntity fallingBlockEntity = FallingBlockEntity.spawnFromBlock(world, pos, BlocksRegistry.LOOSE_DIRT_BLOCK.getDefaultState());
    ...
    public static void setToDirt(BlockState state, World world, BlockPos pos) {
        world.setBlockState(pos, pushEntitiesUpBeforeBlockChange(state, BlocksRegistry.LOOSE_DIRT_BLOCK.getDefaultState(), world, pos));
    }
