...
import com.github.theredbrain.redbrainstweaks.block.BasketBlock;
import com.github.theredbrain.redbrainstweaks.registry.EntitiesRegistry;
import com.github.theredbrain.redbrainstweaks.screen.BasketScreenHandler;
...
public class BasketBlockEntity extends LootableContainerBlockEntity implements Hopper {
    ...
    private static final int MAX_INVENTORY_SIZE = 9;
    ...
    public BasketBlockEntity(BlockPos blockPos, BlockState blockState) {
        this(EntitiesRegistry.BASKET_ENTITY, blockPos, blockState);
    }
    ...
    protected Text getContainerName() {
        return RedBrainsTweaks.i18n("container.basket");
    }

    @Override
    protected ScreenHandler createScreenHandler(int syncId, PlayerInventory playerInventory) {
        return BasketScreenHandler.createGeneric9x1(syncId, playerInventory, this);
    }
