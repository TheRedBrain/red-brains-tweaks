...
//	public static final Item DIAMOND_INGOT_ITEM = new Item(new FabricItemSettings().maxCount(64).group(ItemGroup.MATERIALS));
	...
	private void registerItems() {
		Registry.register(Registry.ITEM, new Identifier("redbrainstweaks", "grass_slab"), new BlockItem(GRASS_SLAB, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
		Registry.register(Registry.ITEM, new Identifier("redbrainstweaks", "dirt_slab"), new BlockItem(DIRT_SLAB, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
		Registry.register(Registry.ITEM, new Identifier("redbrainstweaks", "coarse_dirt_slab"), new BlockItem(COARSE_DIRT_SLAB, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
		Registry.register(Registry.ITEM, new Identifier("redbrainstweaks", "podzol_slab"), new BlockItem(PODZOL_SLAB, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
		Registry.register(Registry.ITEM, new Identifier("redbrainstweaks", "mycelium_slab"), new BlockItem(MYCELIUM_SLAB, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
		Registry.register(Registry.ITEM, new Identifier("redbrainstweaks", "rooted_dirt_slab"), new BlockItem(ROOTED_DIRT_SLAB, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
		Registry.register(Registry.ITEM, new Identifier("redbrainstweaks", "sand_slab"), new BlockItem(SAND_SLAB, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
		Registry.register(Registry.ITEM, new Identifier("redbrainstweaks", "red_sand_slab"), new BlockItem(RED_SAND_SLAB, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
		Registry.register(Registry.ITEM, new Identifier("redbrainstweaks", "gravel_slab"), new BlockItem(GRAVEL_SLAB, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
